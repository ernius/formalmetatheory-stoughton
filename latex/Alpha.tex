...
\>[6]\AgdaSymbol{:} \AgdaSymbol{\{}\AgdaBound{x} \AgdaSymbol{:} \AgdaFunction{V}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaSymbol{(}\AgdaInductiveConstructor{v} \AgdaBound{x}\AgdaSymbol{)} \AgdaDatatype{∼α} \AgdaInductiveConstructor{v} \AgdaBound{x}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaSymbol{→} \AgdaBound{y} \AgdaDatatype{\#} \AgdaInductiveConstructor{ƛ} \AgdaBound{x} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{y} \AgdaDatatype{\#} \AgdaInductiveConstructor{ƛ} \AgdaBound{x'} \AgdaBound{M'} \<[32]%
\>[32]\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaSymbol{→} \AgdaBound{M} \AgdaFunction{∙} \AgdaFunction{ι} \AgdaFunction{≺+} \AgdaSymbol{(}\AgdaBound{x} \AgdaInductiveConstructor{,} \AgdaInductiveConstructor{v} \AgdaBound{y}\AgdaSymbol{)} \AgdaDatatype{∼α} \AgdaBound{M'} \AgdaFunction{∙} \AgdaFunction{ι} \AgdaFunction{≺+} \AgdaSymbol{(}\AgdaBound{x'} \AgdaInductiveConstructor{,} \AgdaInductiveConstructor{v} \AgdaBound{y}\AgdaSymbol{)}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaSymbol{→} \AgdaInductiveConstructor{ƛ} \AgdaBound{x} \AgdaBound{M} \AgdaDatatype{∼α} \AgdaInductiveConstructor{ƛ} \AgdaBound{x'} \AgdaBound{M'}\<%
\end{code}

\begin{code}%
\>\AgdaKeyword{infix} \AgdaNumber{1} \_∼α\_⇂\_\<%
\\
...
%
\\
\>\AgdaFunction{lemmaι∼α⇂} \AgdaSymbol{:} \AgdaSymbol{\{}\AgdaBound{M} \AgdaSymbol{:} \AgdaDatatype{Λ}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaFunction{ι} \AgdaFunction{∼α} \AgdaFunction{ι} \AgdaFunction{⇂} \AgdaBound{M}\<%
\\
\>\AgdaFunction{lemmaι∼α⇂} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaBound{x} \AgdaSymbol{\_} \AgdaSymbol{=} \AgdaInductiveConstructor{∼v} \<[23]%
\>[23]\<%
\\
%
\\
\>\AgdaFunction{lemma≺+∼α⇂} \AgdaSymbol{:} \AgdaSymbol{\{}\AgdaBound{x} \AgdaSymbol{:} \AgdaFunction{V}\AgdaSymbol{\}\{}\AgdaBound{M} \AgdaBound{N} \AgdaBound{P} \AgdaSymbol{:} \AgdaDatatype{Λ}\AgdaSymbol{\}\{}\AgdaBound{σ} \AgdaBound{σ'} \AgdaSymbol{:} \AgdaFunction{Σ}\AgdaSymbol{\}} \AgdaSymbol{→} \AgdaBound{σ} \AgdaFunction{∼α} \AgdaBound{σ'} \AgdaFunction{⇂} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{N} \AgdaDatatype{∼α} \AgdaBound{P} \AgdaSymbol{→} \AgdaBound{σ} \AgdaFunction{≺+} \AgdaSymbol{(}\AgdaBound{x} \AgdaInductiveConstructor{,} \AgdaBound{N}\AgdaSymbol{)} \AgdaFunction{∼α} \AgdaBound{σ'} \AgdaFunction{≺+} \AgdaSymbol{(}\AgdaBound{x} \AgdaInductiveConstructor{,} \AgdaBound{P}\AgdaSymbol{)} \AgdaFunction{⇂} \AgdaBound{M}\<%
\\
\>\AgdaFunction{lemma≺+∼α⇂} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaBound{σ∼ασ'⇂M} \AgdaBound{N\textasciitildeP} \AgdaBound{y} \AgdaBound{y*M} \AgdaKeyword{with} \AgdaBound{x} \AgdaFunction{≟} \AgdaBound{y}\<%
\\
\>\AgdaSymbol{...} \AgdaSymbol{|} \AgdaInductiveConstructor{yes} \<[11]%
\>[11]\AgdaSymbol{\_} \AgdaSymbol{=} \AgdaBound{N\textasciitildeP} \<[19]%
\>[19]\<%
\\
\>\AgdaSymbol{...} \AgdaSymbol{|} \AgdaInductiveConstructor{no} \<[11]%
\>[11]\AgdaSymbol{\_} \AgdaSymbol{=} \AgdaBound{σ∼ασ'⇂M} \AgdaBound{y} \AgdaBound{y*M} \<%
\end{code}
...
\begin{code}%
\>\AgdaFunction{lemmaM∼N\#} \AgdaSymbol{:} \<[13]%
\>[13]\AgdaSymbol{\{}\AgdaBound{M} \AgdaBound{N} \AgdaSymbol{:} \AgdaDatatype{Λ}\AgdaSymbol{\}}\<%
\\
\>[2]\AgdaIndent{13}{}\<[13]%
\>[13]\AgdaSymbol{→} \AgdaBound{M} \AgdaDatatype{∼α} \AgdaBound{N}\<%
\\
\>[2]\AgdaIndent{13}{}\<[13]%
\>[13]\AgdaSymbol{→} \AgdaSymbol{(}\AgdaBound{z} \AgdaSymbol{:} \AgdaFunction{V}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaBound{z} \AgdaDatatype{\#} \AgdaBound{M} \AgdaSymbol{→} \AgdaBound{z} \AgdaDatatype{\#} \AgdaBound{N}\<%
\\
\>\AgdaFunction{lemmaM∼N\#} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}} \AgdaBound{M∼N} \AgdaBound{z} \AgdaBound{z\#M} \AgdaKeyword{with} \AgdaBound{z} \AgdaFunction{\#?} \AgdaBound{N}\<%
\\
\>\AgdaSymbol{...} \AgdaSymbol{|} \AgdaInductiveConstructor{yes} \AgdaBound{z\#N} \<[16]%
\>[16]\AgdaSymbol{=} \AgdaBound{z\#N}\<%
\\
\>\AgdaSymbol{...} \AgdaSymbol{|} \AgdaInductiveConstructor{no} \<[10]%
\>[10]\AgdaBound{¬z\#N} \<[16]%
\>[16]\AgdaSymbol{=} \AgdaFunction{⊥-elim} \AgdaSymbol{((}\AgdaFunction{lemma-free→¬\#} \AgdaSymbol{(}\AgdaFunction{lemmaM∼M'→free←} \AgdaBound{M∼N} \AgdaBound{z} \AgdaSymbol{(}\AgdaFunction{lemma¬\#→free} \AgdaBound{¬z\#N}\AgdaSymbol{)))} \AgdaBound{z\#M}\AgdaSymbol{)} \<%
\end{code}
